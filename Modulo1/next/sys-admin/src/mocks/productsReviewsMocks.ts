    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Produto excelente! Superou minhas expectativas. A qualidade da câmera é incrível, veja as fotos que tirei:",
        images: [
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Muito bom, mas o preço poderia ser melhor. Entrega foi rápida.",
        images: [],
      },
      {
        id: 3,
        ...
        rating: 5,
        comment:
          "Chegou rapidinho e bem embalado. Aqui algumas fotos da embalagem e do produto:",
        images: [
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Bom produto, mas demorou um pouco para chegar. Funcionando perfeitamente!",
        images: [],
      },
    ],
  },
